...
export default function ExportableBracket({
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="bg-asphalt-panel border border-asphalt-border rounded-sm p-5">
        <div className="mb-4">
      ...
      {/*
        ...
        rodadas expostas lado a lado. Fica fora da tela (position absolute
        + visibilidade controlada), mas continua no DOM para que o
        html-to-image consiga capturá-la por completo, sem cortes.
      */}
      {matches.length > 0 && (
